function [h,H,HCR,HCY,HCG,HCB,J,Q,s,C,M]=ciecam97a(test,white,back,LA,surr,adap,Mc,Mop)
...
% SYNTAX
% ----------------------------------------------------------------------------
% [h,H,HCR,HCY,HCG,HCB,J,Q,s,C,M]=CIECAM97a(xyY,xyYW,xyYB,YA,VIEW,ADAP,Mc,Mop);
%
